...
function Calculator() {
  ...
  const calculate = () => {
    if (sign === "+") setResult(Number(num1) + Number(num2));
    else if (sign === "-") setResult(Number(num1) - Number(num2));
    else if (sign === "*") setResult(Number(num1) * Number(num2));
    else if (sign === "/") setResult(Number(num1) / Number(num2));
  };
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gray-100">
      <div className="bg-white shadow-lg rounded-2xl p-6 w-80">
        <div className="bg-gray-200 rounded-lg p-4 text-right text-2xl font-mono mb-4">
